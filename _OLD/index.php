...
<body class="antialiased">
  ...
  <main id="main">
    ...
    <!-- ======= Clients Section ======= -->
    <section id="clients" class="clients clients" title=''>
      <div class="container">

        <div class="row">

          <div class="col-lg-2 col-md-4 col-6">
            <img src="_webSiteAssets/assets/img/clients/gmsLogo.png" class="img-fluid" alt="" data-aos="zoom-in" style="width: 70%;">
          </div>

          <div class="col-lg-2 col-md-4 col-6">
            <img src="_webSiteAssets/assets/img/clients/sciKansourouba.png" class="img-fluid" alt="" data-aos="zoom-in" data-aos-delay="100">
          </div>

          <div class="col-lg-2 col-md-4 col-6">
            <img src="_webSiteAssets/assets/img/clients/yafimmoLogo.png" class="img-fluid" alt="" data-aos="zoom-in" data-aos-delay="200" style="width: 70%;">
          </div>

          <div class="col-lg-2 col-md-4 col-6">
            <img src="_webSiteAssets/assets/img/clients/dmimmoLogo.png" class="img-fluid" alt="" data-aos="zoom-in" data-aos-delay="300">
          </div>

          <div class="col-lg-2 col-md-4 col-6">
            <img src="_webSiteAssets/assets/img/clients/titaniumLogo.png" class="img-fluid" alt="" data-aos="zoom-in" data-aos-delay="400" style="width: 70%;">
          </div>

          <div class="col-lg-2 col-md-4 col-6">
            <img src="_webSiteAssets/assets/img/clients/edineImmoLogo.png" class="img-fluid" alt="" data-aos="zoom-in" data-aos-delay="500">
          </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="contact-about">
              ...
              <div class="social-links">
                <a href="https://web.facebook.com/profile.php?id=100091415350647" target="_blank" class="facebook"><i class="icofont-facebook"></i></a>
                <a href="https://www.youtube.com/channel/UCiY3zoP-aFPweYFJGwAM5yw" target="_blank" class="youtube"><i class="icofont-youtube"></i></a>
  ...
  <footer id="footer" style="text-align: center;">
    <div class="container">
      <div class="">
        <div>
          <div class="copyright">
            2020 - <?=date("Y") ?> Copyright &copy; <strong>WIMMO-MultiServces</strong>. Tous les droits sont réservés. Créé par <a href="https://web.facebook.com/WAgroupe" target="_blank" >WIMMO-MultiServces</a>
            <div class="credits">
            </div>
          </div>
        </div>
